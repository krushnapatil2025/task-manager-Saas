...
const MonthView = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50/50 dark:bg-zinc-950 overflow-x-auto">
      <div className="min-w-[640px] md:min-w-0 flex-1 flex flex-col">
        {/* Weekdays Headers */}
        <div className="grid grid-cols-7 border-b border-slate-200/50 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-md py-2 text-center text-[10px] font-extrabold uppercase tracking-wider text-slate-400 dark:text-zinc-550">
